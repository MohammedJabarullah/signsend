...
var SignCapture = function(canvasWrapperId) {

	var newSignature = canvasWrapperId + "NewSignature";

	function setup() {

		var parent = document.getElementById(canvasWrapperId);
